...
console.log("[workerMeta] iniciado correctamente:", process.argv.slice(2));
// ===== CLI =====
...
// Crear meta provisional (evita que el frontend lea un archivo inexistente)
fs.writeFileSync(
  metaPath,
  JSON.stringify({ ok: false, ready: false }, null, 2),
  "utf8"
);
// ===== util =====
...
(async () => {
  ...
  try {
    ...
    for await (const raw of rl) {
      ...
      totalRows++;
      // Registro de progreso para el frontend
